...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // FIX: this button previously had no onclick and no JS listener,
    // so tapping it did nothing. It now reveals the mobile content
    // directly, same as if the site had detected a phone.
